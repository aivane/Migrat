...
<template>
  <section>
    ...
    <section class="summary-grid">
      ...
      <article class="summary-panel">
        <div class="panel-title"><span>กระจายตามประเทศ/ภูมิภาคที่ลงทุน</span></div>
        <div class="bar-list">
    ...
    <section class="tool-row">
      <form class="search-box" @submit.prevent>
        <input v-model="state.search" placeholder="ค้นหาชื่อกองทุน, ประเทศ, หุ้นที่ถือ..." />
      </form>
      <div class="filters">
        ...
        <table>
          <thead>
            <tr>
              ...
              <th @click="setSort('country')">ประเทศ/ภูมิภาค</th>
