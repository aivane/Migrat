...
const FUNDS = [
  ...
  { id: 'SCBGOLDH', type: 'feeder', sector: 'Gold', name: 'ไทยพาณิชย์ ทองคำ ป้องกันความเสี่ยง', amc: 'SCB', amcFull: 'ไทยพาณิชย์', nav: 21.45, chg1d: 0.75, ret1m: 4.5, perf: 21.0, ret3y: 16.8, risk: 8, div: 0.0, aum: 39800, master: 'SPDR Gold Shares (GLD)', holdings: [['SPDR Gold Trust (GLD)', 88.5], ['Physical Gold Bullion', 7.2], ['Cash & Equivalents', 4.3]], starred: true },
...
export { FUNDS, THEME_FLOWS, THEMES, UPTREND_FUNDS, STOCKS_DB, ARTICLES_LIST, FEATURED_ARTICLE, FAQ_LIST };
