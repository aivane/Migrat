  ...
  const legacyCards = computed(() => {
    ...
    return [
      ...
      },
      {
        ...
        desc: 'ดูรายการที่สร้างกระแสเงินสดจากเงินปันผลสูง',
    ...
    return [
      {
        ...
        emoji: '🏦',
        title: 'ถือโดยกองทุนมากที่สุด',
        desc: 'จำนวนกองทุนที่พบหุ้นแต่ละตัวใน Top Holdings',
      ...
      },
      {
        ...
        emoji: '⚖️',
        title: 'น้ำหนักรวมสูงสุด',
        desc: 'น้ำหนักหุ้นรวมจากกองทุนที่คัดเลือก',
      ...
      },
      {
        key: 'stock-return',
        emoji: '📈',
        title: 'ผลตอบแทนหุ้นสูงสุด',
        desc: 'ผลตอบแทนของหุ้นรายตัวตามช่วงเวลาที่เลือก',
        list: sortRanked(rows, (a, b) => b.retP[state.rk.ret] - a.retP[state.rk.ret]),
        valueType: 'percent',
        pillKind: 'ret',
        pillOptions: [['m1', '1M'], ['q1', '3M'], ['y1', '1Y']],
      },
    ]
  })
    ...
    return [
      {
        ...
        desc: 'กระแสเงินลงทุนสุทธิตามช่วงเวลาที่เลือก',
      ...
      },
      {
        ...
        desc: 'ผลตอบแทนกองทุนตามช่วงเวลาที่เลือก',
        list: sortRanked(rows, (a, b) => b.retP[state.rk.ret] - a.retP[state.rk.ret]),
        valueType: 'percent',
        pillKind: 'ret',
      ...
      },
      {
        ...
        desc: 'อัตราเงินปันผลของกองทุนในกลุ่มที่เลือก',
